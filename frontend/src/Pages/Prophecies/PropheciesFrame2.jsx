...
<div className="Prophecies-row">
  ...
  <img src="./img/thakura.png" alt="image-loading"/>
  ...
  <img src="./img/mahaprabhu.png" alt="image-loading"/>
  ...
  <img src="./img/krishna.png" alt="image-loading" />
...
<div className='Prophecies-arrow'>
  ...
  <img src="./img/sri.png" alt="image-loading" />
    <h2>Sri Bhaktivinoda Thakura</h2>
