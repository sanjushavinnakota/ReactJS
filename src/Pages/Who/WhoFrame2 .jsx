  ...
  return (
    <div>
     <div className='reference'>
      <div className='reference-para'>
<h5>Refrence:</h5>
<p>Excerpts from The Jaladuta Diary, 1965 - Journey to the U.S.A.</p>
        </div>
     ...
     <div className='video'>
     <iframe  src="https://www.youtube.com/embed/kiwrmUg9h3Y" title="Biography of His Divine Grace A.C. Bhaktivedanta Swami Prabhupada" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen style={{width:"60%",height:"80%", marginLeft:"auto", marginRight:"auto"}}></iframe>
     </div>
<div className='divine'>
  <h1  style={{lineHeight:"3rem"}}>His Divine Grace A.C. Bhaktivedanta Swami Srila Prabhupada</h1>
  <p>When he entered the port of New York City on September 17, 1965 few Americans took notice, but he was not merely another immigrant. He was on a mission to introduce the ancient teachings of Vedic India into mainstream America. Before Srila Prabhupada passed away on November 14, 1977 at the age of 81, his mission proved successful. He had founded the International Society for Krishna Consciousness (ISKCON) and saw it grow into a worldwide confederation of more than 100 temples, ashrams and cultural centers.</p>
</div>

<div className='earlylife'>
  <h3  style={{lineHeight:"3rem"}}>Srila Prabhupada’s Early Life</h3>
<p>Srila Prabhupada was born to Abhay Charan De on September 1, 1896 to a pious Hindu family in Calcutta. As a youth growing up in British - controlled India, Abhay became involved with Mahatma Gandhi’s civil disobedience movement to secure independence for his nation. It was, however, a 1922 meeting with a prominent scholar and religious leader, Srila Bhaktisiddhanta Sarasvati, which proved most influential on Abhay’s future calling.</p>
<p>Srila Bhaktisiddhanta was a leader in the Gaudiya Vaishnava denomination, a monotheistic tradition within the broad Hindu culture, and asked Abhay to bring the teachings of Lord Krishna to the English-speaking world. Abhay became a disciple of Srila Bhaktisiddhanta in 1933, and resolved to carry out his mentor’s request. Abhay, later known by the honorific A.C. Bhaktivedanta Swami Prabhupada, spent the next 32 years preparing for his journey west.</p>
</div>
<div className='journey'>
<img src="/img/pp1.png" alt="journey-image"  />
<div className='journey-1'>
  <h3  style={{lineHeight:"3rem"}}>Srila Prabhupada’s Journey to West and Founding of ISKCON</h3>
...
<div className='guiding'>
  ...
  <p>Ancient scriptures of India extol the virtues of a true spiritualist. The Bhagavad-gita, Srimad Bhagavatam, Chaitanya Charitamrita, Bhakti Rasamrita Sindhu list 85 qualities a true spiritualist should possess and one can note that Srila Prabhupada had all of the above qualities in completeness.</p>

</div>

<div className='objective'>
<h3  style={{lineHeight:"3rem"}}>What Is Our Objective</h3>
<p>The objective of this app, Srila Prabhupada lila, is to curate the history of Srila Prabhupada and his institutions, extol his divine qualities, his legacy, his disciples etc. We request the users of the app to appreciate and connect themselves with Srila Prabhupada, the greatest ambassador of Indian spiritualism.</p>
<p>Classification of Pastimes:Many devotees who regularly chant 16 rounds of the Hare Krishna Maha-mantra have worked with great care to index the Memories of Srila Prabhupada against the following:</p>
<p>.85 Qualities of a Pure Devotee
.125 Keywords or Topics
.Location where it happened
.Devotee who narrated it</p>
<p>These classifications have also been verified by a few other volunteers.</p>
<p>Srila Prabhupada is a pure devotee of Lord Krishna and there are many facets to his lila. In spite of our best efforts, it is quite possible that we might have erred in classifying a Memory appropriately. We request our readers to mail us their feedback at srilaprabhupadalila@gmail.com . With your help, we can definitely improve our understanding of Srila Prabhupada’s Lila.</p>
</div>
<div className='reference'>
      <div className='reference-para'>
<h5>Refrence:</h5>
...
<hr  style={{color:"#C7C7C7"}}/>
<div class="Recently-row2">
  <div class="Recently-column2" >
    <img className src="./img/explosion.png" alt="explosion-image" />
    <h5  style={{lineHeight:"3rem"}}>The Hare Krishna Explosion</h5>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna...</p>
        <button>Read more</button>
    </div>
    <div class="Recently-column2" >
    <img className src="./img/pp5.png" alt="pp5-image" />
    <h5  style={{lineHeight:"3rem"}}>Devotees doing kirtan on a flight</h5>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna..</p>
        <button>Read more</button>
    ...
    <div class="Recently-column2" >
    <img className src="./img/pp1.png" alt="pp1-image" />
    <h5  style={{lineHeight:"3rem"}}>Krsna Conscious Community</h5>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna..</p>
        <button>Read more</button>
    </div>
