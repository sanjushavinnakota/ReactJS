...
<div className='Footer-GooglePlay'><a className="btn btn-google" href="/" title="Google Play">Google Play</a></div>
<div className='Footer-AppStore'><a href="/" tabIndex="0"><img className="bn46" src="https://developer.apple.com/assets/elements/badges/download-on-the-app-store.svg"alt="bn45"/></a></div>
</div>
</div>
<hr className="Footer-new1"></hr>
<div></div>
