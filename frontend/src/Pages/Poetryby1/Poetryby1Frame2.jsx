...
import './Poetryby1Frame2.css'





const Poetryby1Frame2 = () => {
  return (
    <div>
...
<p>Excerpts from The Jaladuta Diary, 1965 - Journey to the U.S.A.</p>
 ...
 <h4>Bhagavan Krishna Pada-Padme Prarthana</h4>
 
 <button>Close</button>
 </div>
 <div className='image'>
 <img src="./img/poetryby1.png" alt="image-loading"/>
</div>
 <div className='para'>
  
 <h1>''</h1>
 <h1>Bhagavan Krishna Pada-Padme Prarthana</h1>
  <p>(refrain)</p><p>
krishna taba punya habe bhai
e-punya koribe jabe radharani khusi habe
dhruva ati boli toma tai</p>
<p>
...
krishna-bhakti dey thai thai</p>
<p>
...
<p>
Today that remembrance of You came to me in a very nice way. Because I have a great longing I called to You. I am Your eternal servant and therefore I desire Your association so much. O Lord Krishna, except for You there is no other means of success.</p>
 </div>
 <div className='heading'>
      <button className='next'>Next</button>
      <button className='back'>Back</button>
...
export default Poetryby1Frame2;
